...
namespace CustomerClass_ArrayObject
{
    class Customer
    {
        public int id;
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            Customer[] cust = new Customer[]
            {
                ...
                new Customer() {id = 5, name = "Manoj", mobile = "555555555"}
            };
            ...
            //lamda
            cust.ToList().ForEach(c => Console.WriteLine($"id = {c.id}, name = {c.name}, mobile = {c.mobile}"));
